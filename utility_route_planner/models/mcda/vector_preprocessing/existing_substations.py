...
class ExistingSubstations(VectorPreprocessorBase):
    criterion = "existing_substations"
    ...
    def _set_suitability_values(input_gdf: gpd.GeoDataFrame, weight_values: dict) -> gpd.GeoDataFrame:
        logger.info("Setting suitability value.")
        input_gdf["suitability_value"] = weight_values["alliander_middenspanningsstation"]
        return input_gdf
