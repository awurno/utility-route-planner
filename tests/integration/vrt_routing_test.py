...
class TestVRTRouting:
    ...
    def test_vrt_results_in_same_route_as_single_tiff(
        ...
        # TODO fix this one, check if the changed preset is the reason as the hardcoded tif does not match now.
        print(route_for_tiff_file.length)
        print(route_using_vrt.length)
